  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `https://tanuan-backend.herokuapp.com/api/vaccinator/update-vaccinator-information`,
        form
      );
  ...
  const fetchUserData = async () => {
    try {
      ...
      const { data } = await axios.get(
        `https://tanuan-backend.herokuapp.com/api/vaccinator/get-vaccinator/${id}`
      );

      // setUserData(data.vaccinator);
