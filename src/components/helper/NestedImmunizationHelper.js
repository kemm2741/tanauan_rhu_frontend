...
const NestedImmunizationHelper = ({ id, title, usersArray }) => {
        ...
        editable={{
          onRowAdd: (newData, oldData) =>
            new Promise((resolve, reject) => {
              axios
                .put(
                  `https://tanuan-backend.herokuapp.com/api/children/addVaccinatedChild/${id}`,
                  newData
                )
                .then(({ data }) => {
                  const reversedChild = [
...
export default NestedImmunizationHelper;
