          ...
          <Grid item xs={12} sm={4}>
            <Paper className={classes.paper}>
              <Typography className={classes.titleText} variant="h4">
                Tanauan Delightful Place
              </Typography>
              <Typography variant="p">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                ipsum vitae incidunt, omnis a ad, illum quaerat dolor quibusdam
                tempore officiis iste unde rerum neque temporibus nulla debitis
                amet earum mollitia culpa esse nesciunt cupiditate deserunt. In
                mollitia.
              </Typography>
              <br />
              <br />
              <Typography variant="p">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                ipsum vitae incidunt, omnis a ad, illum quaerat dolor quibusdam
                e unde rerum neque temporibus nulla debitis amet earum mollitia
                culpa esse nesciunt cupiditate deserunt. In mollitia repudiandae
                explicabo optio pariatur.
              </Typography>
            </Paper>
          </Grid>
        </Grid>
      ...
      <div className={classes.containerBox}>
        <Grid container spacing={2}>
          <Grid item xs={12} sm={3}>
            <Paper className={classes.paperBox}>
              <div className={classes.icons}>
                <AiOutlinePhone color="3F51B5" size={50} />
              </div>

              <Typography variant="p">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Voluptatibus natus id saepe minima voluptates magni dicta magnam
                aut, quasi culpa!
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} sm={3}>
            <Paper className={classes.paperBox}>
              <div className={classes.icons}>
                <AiOutlineMail color="3F51B5" size={50} />
              </div>
          ...
          <Grid item xs={12} sm={3}>
            <Paper className={classes.paperBox}>
              <div className={classes.icons}>
                <AiFillFacebook color="3F51B5" size={50} />
              </div>
          ...
          <Grid item xs={12} sm={3}>
            <Paper className={classes.paperBox}>
              <div className={classes.icons}>
                <GiHealthNormal color="3F51B5" size={50} />
              </div>
